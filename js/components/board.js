...
function getPosTemplate(pos) { return `
    <div class="triangle-container">
        ...
        <div class="stack-a">
            ${pos.piecesA.map((team) => (`<piece-component data-team="${team}"></piece-component>`)).join('')}
        </div>
        <div class="stack-b">
            ${pos.piecesB.map((team) => (`<piece-component data-team="${team}"></piece-component>`)).join('')}
        </div>
        <div class="stack-c">
            ${pos.piecesC.map((team) => (`<piece-component data-team="${team}"></piece-component>`)).join('')}
        </div>
        <div class="stack-d">
            ${pos.piecesD.map((team) => (`<piece-component data-team="${team}"></piece-component>`)).join('')}
        </div>
